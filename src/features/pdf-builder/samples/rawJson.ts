...
export const editorBlocks = {
  blocks: [
    ...
    {
      key: 'bps4d',
      text: 'COLORED CENTERED HEADER TEXT',
      type: 'header-one',
      depth: 0,
      inlineStyleRanges: [
        { offset: 0, length: 3, style: 'color-rgb(97,189,109)' },
        { offset: 3, length: 3, style: 'color-rgb(44,130,201)' },
        { offset: 6, length: 4, style: 'color-rgb(85,57,130)' },
        { offset: 10, length: 3, style: 'color-rgb(247,218,100)' },
        { offset: 13, length: 3, style: 'color-rgb(209,72,65)' },
        { offset: 17, length: 3, style: 'color-rgb(243,121,52)' },
        { offset: 20, length: 3, style: 'color-rgb(163,143,132)' },
        { offset: 23, length: 5, style: 'color-rgb(209,213,216)' },
      ],
      entityRanges: [],
